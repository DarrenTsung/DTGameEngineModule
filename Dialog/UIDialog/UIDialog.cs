  ...
  public class UIDialog : BasicDialog<UIDialogModel, UIDialogKeyframe> {
    ...
    private void Cleanup() {
      if (this._characterPrefab != null) {
        ObjectPoolManager.Recycle(this._characterPrefab);
      }
    ...
    private void CreateNewKeyframe() {
      ...
      this._characterPrefab = ObjectPoolManager.Instantiate(currentKeyframe.characterPrefabName, parent : this._container, worldPositionStays : false);
